...
import { FiArrowLeft, FiPlus, FiTrash2, FiImage, FiCheck, FiX } from 'react-icons/fi';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <h1 className="text-3xl font-bold mt-2">Nuova Attività</h1>
            </div>
          </div>
          ...
          {success && (
            <div className="bg-green-500/20 backdrop-blur-sm border border-green-500/30 text-green-200 p-4 rounded-xl mb-6">
              <div className="flex items-center gap-2">
                ...
                <span>Attività creata con successo! Reindirizzamento in corso...</span>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-6 py-3 bg-[#FEF5E7] text-[#1E4E68] rounded-xl hover:bg-[#FEF5E7]/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
