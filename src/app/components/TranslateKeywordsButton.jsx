...
/**
 * Componente pulsante per tradurre automaticamente le parole chiave di una categoria
 * in diverse lingue utilizzando l'API OpenAI.
 * 
 * @param {Object} props - Proprietà del componente
 * @param {string} props.category - Categoria delle parole chiave da tradurre
 * @param {boolean} props.compact - Se true, mostra solo l'icona senza testo
 */
export default function TranslateKeywordsButton({ category, compact = false }) {
  ...
  const handleTranslate = async (targetLanguages = null) => {
    ...
    try {
      const response = await fetch('/api/keywords/translate', {
        method: 'POST',
        headers: {
    ...
    <div className="relative">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {!compact && <span>Traduci Parole Chiave</span>}
        </button>
